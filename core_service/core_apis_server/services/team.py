...
from core_service.core_apis_server.models.models import Team, Organization, Member
...
class TeamService(BaseService):
    ...
    def _update_org_teams_count(self, organization_id: str):
    ...
    async def create_team(self, organization_id: str,
        ...
        self._update_org_teams_count(organization_id)
    ...
    async def update_team(self, team_id: str,
                           payload: TeamUpdate) -> Team:
    ...
    async def delete_team(self, team_id: str):
        ...
        self._update_org_teams_count(org_id)